...
export default function ProductEdit({ product, categories, units }: ProductEditProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        allow_tingi: product.allow_tingi ?? false,
        tingi_price: product.tingi_price?.toString() || '',
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post(`/products/${product.id}`, data, {
            ...
            onError: (errors) => {
                toast.error(Object.values(errors)[0] as string || 'Failed to update product');
            },
            onFinish: () => {
    ...
    return (
        <TenantLayout title="Edit Product">
            <Head title="Edit Product" />

            {/* Header */}
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-4">
                    <Link href={`/products/${product.id}`} className="p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg">
