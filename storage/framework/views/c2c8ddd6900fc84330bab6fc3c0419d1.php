...
<body>
    <div class="container">
        ...
        <div class="body">
            <p class="greeting">Hi <?php echo e($userName); ?>,</p>
            <p class="message">
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> PadayON by CantiumCode. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\Administrator\Documents\PadayON\resources\views/emails/password-reset-otp.blade.php ENDPATH**/ ?>